                                ...
                                {selectedCustomer ? (
                                    <div className="flex items-center justify-between px-3 sm:px-4 py-1 bg-white border-2 border-indigo-300 rounded-xl">
                                        <div className="flex flex-col">
                                            <p className="mb-0 text-sm sm:text-lg font-medium text-gray-900">{selectedCustomer.name}</p>
                                        ...
                                        {isDropdownOpen && customerOptions.length > 0 && (
                                            <div className="absolute z-20 w-full mt-2 bg-white border-2 border-gray-200 rounded-xl shadow-xl max-h-60 overflow-y-auto">
                                                {customerOptions.map((cus, index) => (
                                                    ...
                                                    >
                                                        <div className="font-semibold text-sm sm:text-md text-gray-900">{cus.name}</div>
